...
const PHOTO_TEXTURES: Record<string, string> = {
  'red-brick': images.redBrick,
  'exposed-brick': images.exposedBrick,
  'stone': images.stone,
  'wood-panel': images.woodPanel,
  'concrete-block': images.concreteBlock,
...
const FLOOR_TEXTURES: Record<string, string> = {
  'light-oak': images.lightOak,
  'walnut': images.walnut,
  'bamboo': images.bamboo,
  'laminate': images.laminate,
  'ceramic-white': images.ceramicWhite,
  'ceramic-gray': images.ceramicGray,
  'porcelain': images.porcelain,
  'marble-white': images.marbleWhite,
  'marble-dark': images.marbleDark,
  'carpet-beige': images.carpetBeige,
  'carpet-gray': images.carpetGray,
  'concrete': images.concrete,
  'slate': images.slate,
  'vinyl': images.vinyl,
};
